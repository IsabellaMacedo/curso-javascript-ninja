...
*/
var pessoa = {'nome' : 'Isabella', 'sobrenome' : 'Macedo', 'sexo' : 'Feminino', 'idade' : 27, 'altura' : '', 'peso' : '', 'andando' : false, caminhouQuantosMetros : 0}; 
...
*/
pessoa.andar = function(qtdMetros) { pessoa.caminhouQuantosMetros += qtdMetros; pessoa.andando = true };
